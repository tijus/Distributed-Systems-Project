...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        /*
        Converting the value stored in the shared preference into a cursor object using
        matrix cursor
         */
        ...
        //Log.v("cursorcount",String.valueOf(matrixCursor.getCount()));
        //Log.v("cursor_key", key);
        //Log.v("cursor_value", value);
        return matrixCursor;
    }
}
